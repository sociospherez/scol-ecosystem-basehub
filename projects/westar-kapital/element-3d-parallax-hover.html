...
<html class="no-js" lang="en">
    ...
    <body data-mobile-nav-style="classic">
        ...
        <header>
            <!-- start navigation -->
            <nav class="navbar navbar-expand-lg header-light disable-fixed header-demo" data-header-hover="light">
        ...
        <!-- end header -->
        <!-- start section --> 
        <section class="p-0 ipad-top-space-margin full-screen md-h-700px sm-h-450px position-relative overflow-hidden cover-background" style="background-image: url('images/demo-3d-parallax-bg.jpg')">
                        ...
                        <div class="atropos-scale">
                            <div class="atropos-rotate">
                                <div class="atropos-inner text-center">
                                    <div data-atropos-offset="-8" class="position-absolute left-0px right-0px top-100px lg-top-50px lg-w-70 md-w-75 mx-auto" data-anime='{ "scale":[1.2,1], "opacity": [0,1], "duration": 500, "delay": 0, "staggervalue": 200, "easing": "easeOutQuad" }'>
                                        <img src="https://placehold.co/824x746" alt="">
                                    </div>
                                    <img data-atropos-offset="3" class="position-relative z-index-9 lg-w-80 md-w-90 sm-w-100" src="https://placehold.co/976x852" alt="" data-anime='{ "translateY": [50, 0], "rotateX": [10, 0], "perspective": [1000,1200], "scale": [1.1, 1], "opacity": [0,1], "duration": 800, "delay": 200, "staggervalue": 300, "easing": "easeOutQuad" }'>
                                </div> 
                            </div>
                        </div>   
                    </div> 
                            ...
                            <div class="atropos-rotate">
                                <div class="atropos-inner text-center overflow-visible position-relative">
                                    <div data-atropos-offset="-8">
                                        <span class="fs-275 lg-fs-200 sm-fs-140 text-dark-gray fw-500 ls-minus-5px">create brands</span>
                                    </div>
                                    <span class="fs-200 md-fs-170 xs-fs-110 text-white ls-minus-5px text-shadow-double-large fw-600 position-absolute absolute-middle-center text-white-space-nowrap z-index-1">design</span>
                                </div> 
                            </div>
                        </div>   
                    </div> 
                        ...
                        <div class="atropos-scale">
                            <div class="atropos-rotate">
                                <div class="atropos-inner text-center overflow-visible">
                                    <div data-atropos-offset="0" class="position-absolute left-0px right-0px mx-auto lg-w-80 sm-w-100" data-anime='{ "scale":[1.2,1], "opacity": [0,1], "duration": 500, "delay": 0, "staggervalue": 200, "easing": "easeOutQuad" }'>
                                        <img src="https://placehold.co/900x870" alt="">
                                    </div>
                                    <img data-atropos-offset="2.5" class="position-relative top-10px z-index-9 lg-w-80 sm-w-100" src="https://placehold.co/900x870" alt="" data-anime='{ "scale":[0.9,1], "opacity": [0,1], "duration": 500, "delay": 0, "staggervalue": 200, "easing": "easeOutQuad" }'>
                                </div> 
                            </div>
                        </div>   
                    </div> 
        ...
        <!-- end section -->
        <!-- start section --> 
        <section class="p-0 full-screen md-h-700px sm-h-500px position-relative overflow-hidden" style="background-image: url('images/demo-3d-parallax-hover-bg2.jpg')">
            <!-- start marquees -->
            <div class="position-absolute absolute-middle-center fw-600 fs-400 md-fs-200 ls-minus-10px text-nowrap" style="color: #dfc6a9"><div data-bottom-top="transform: translateX(-150px)" data-top-bottom="transform: translateX(150px)">makeup beauty</div></div> 
            <!-- end marquees -->
            <div class="container h-100 position-relative z-index-9">
                <div class="row align-items-center justify-content-center text-center h-100">
                    <div class="col-md-12 position-relative atropos transform-3d position-relative" data-atropos>
                        <div class="atropos-scale">
                            <div class="atropos-rotate position-relative">
                                <div class="atropos-inner text-center overflow-visible position-relative">
                                    <div data-atropos-offset="-4" class="position-absolute left-minus-50px md-left-0px right-0px top-minus-30px sm-top-0px">
                                        <img src="https://placehold.co/701x844" alt="">
                                    </div>
                                    <img data-atropos-offset="-3" class="position-relative top-minus-30px left-minus-50px md-left-0px z-index-1" src="https://placehold.co/701x844" alt="">
                                    <img data-atropos-offset="5" class="position-absolute left-150px lg-left-20px top-minus-50px" src="https://placehold.co/701x844" alt="">
                                </div> 
                            </div>
                        </div>   
                    </div>
